...
const CurriculumPart = (props) => {
  ...
  const isTakeCheck = (e) => {
    if (
      (props.isWaiting == true || props.classRoomData.isTake === false) &&
      ...
      try {
        ...
        if (res.data) {
          res.data.playlist
            ...
            : (contentVideoNum[contentId] = 0);
          setContentVideoNum(
            { ...contentVideoNum },
            contentVideoNum[contentId]
          );
  ...
  const deleteLecture = async (e) => {
    ...
    if (
      window.confirm(
        e.lectureNum + "강이 삭제됩니다. 정말 삭제하시겠습니까?"
      ) == true
    ) {
      const response = await axios
        .post(
          ...
          <Accordion className="accordion-box" preExpanded={"a"}>
            <AccordionItem className="accordion-item" uuid="a">
              ...
              <AccordionItemPanel className="card-body acc-content current">
                {Array.isArray(notices)
                  ? notices
                      .slice(noticeState.start, noticeState.end)
                      .map((notices, i) => (
                        <div className="content">
                          ...
                          <div className="clearfix">
                            ...
                            >
                              {getDateDiff(
                                ...
                                <i
                                  className="fa"
                                  style={{ zIndex: "0", paddingRight: "3px" }}
                                >
                                  <span
                                    style={{
                                      fontWeight: "bold",
                                  ...
                                  <div className="clearfix">
                                    ...
                                    <div className="pull-right">
                                      ...
                                      >
                                        ...
                                        {props.classRoomData.instructor
                                          .userId === userId ? (
                                          <>
                                            <div className="pull-right">
                                              <span
