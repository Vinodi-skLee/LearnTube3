          ...
          <div className="intro-info-tabs border-none row">
            ...
            <div>
              ...
              <div>
                ...
                {/* <div
                    className={"widget-area search-window"}
                    style={
                      isSearchShown ? { display: "block" } : { display: "none" }
                    }
                  >
                    <YoutubeVideoListWidget
                      videos={searchedVideos.items}
                  ...
                  >
                      ...
                      <div class="col-5 lh-base">
                        ...
                        <div class="fw-light mx-3" style={{ fontSize: "10pt" }}>
                          ...
                          <div class="text-start text-mute">
                            {selectedVideo.snippet.publishTime.slice(0, 10)}
                          </div>
                        </div>
                        <div class="mx-3 my-2 border-bottom"></div>
                        <div class="mt-5 mx-md-3 text-start text-muted">
                    ...
                    <div class="row col-10" style={{ marginLeft: "30px" }}>
                      ...
                      <div
                        className={
                          selectedVideo
                            ? "col-12 register-section mx-md-4"
                            : "col-12 register-section mx-md-4 d-none"
                        }
                      >
                        <div className="">
                          <div className="py-3">
                            ...
                            <div className="my-2 text-start mt-4">
                              영상 구간 설정 (원하는 위치에서 버튼을 클릭하세요)
                            </div>

                            <div className="d-flex mb-4">
                              <div className="d-flex justify-content-start">
                                <button
                                  className="createbtn text-center ms-0 rounded-3"
                                  onClick={() =>
                                    onClickStartTime(currentPlayTime)
                                  }
                                >
                                  시작 시간
                                </button>
                              ...
                              <div className="d-flex justify-content-start ms-4">
                                <button
                                  className="createbtn text-center ms-0 rounded-3"
                                  onClick={() =>
                                    onClickEndTime(currentPlayTime)
                                  }
                                >
                                  종료 시간
                                </button>
                            ...
                            <div className="styled-form">
                              ...
                              <form id="contact-form" method="post" action="#">
                                ...
                                <div className="col-12 d-flex justify-content-center mt-4 align-items-center">
                                  <div
                                    className="createbtn text-center mr-20 rounded-3"
                                    role="button"
                                    onClick={(e) => cancelCart()}
                                  >
                                    {/* <button className=" text-center" onClick={() => addVideoToCart(selectedVideo)}>저장</button> */}
                                    취소
                                  </div>
                                  <div
                                    className="createbtn text-center ml-20 rounded-3"
                                    role="button"
                                    onClick={(e) =>
                                      addVideoToCart(selectedVideo)
                                    }
                                  >
                                    {/* <button className=" text-center" onClick={() => addVideoToCart(selectedVideo)}>저장</button> */}
                                    저장
