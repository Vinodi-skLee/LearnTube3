                                ...
                                <div className="widget-area">
                                    <div className="playlist mb-50">
                                        ...
                                        <Playlist_listview
                                            ...
                                            playlistTime="30"
                                        />
                                        <Playlist_listview onPlaylistClick={selectPlaylist} playlistTitle="BFS 알고리즘" playlistTime="79" />
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="p-1">
                                        <div className="row">
                                            <div className="m-0 col-md-3 col-sm-12">
                                                <img className="img-fluid" style={{ minWidth: "120px" }} src="https://i.ytimg.com/vi/vorIqiLM7jc/default.jpg" alt="영상제목" />
                                            </div>
                                            <div className="col-md-9 col-sm-12">
                                                <div className="d-flex h4 text-start">{selectedPlaylist ? selectedPlaylist : "영상제목"}</div>
