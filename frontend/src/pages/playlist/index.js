...
const Playlist = () => {
        ...
        if (managedClassroom) {
            managedClassroom.map((classroom, i) => {
                ...
                const fetchClassRoom = async () => {
                    try {
                        const res1 = await axios.get(`${process.env.REACT_APP_SERVER_URL}/api/classroom?userId=${userId}&classId=${classroom.classId}`);
                        // console.log(res1.data);
                        classroomData = [...classroomData, res1.data];
                        window.sessionStorage.setItem("classroom" + i, JSON.stringify(res1.data));
    ...
    }, [playlistData, setPlaylistData, setUpdatePlaylistTitle, setSavedPlaylistName, setVideoNum, videoNum, setSelectedVideo, selectedVideo, usedPlaylist]);
    useEffect(() => {
    ...
    const deletePlaylist = () => {
        ...
        if (window.confirm(savedPlaylistName + " 플레이리스트를 정말 삭제하시겠습니까?") === true) {
            axios
                            ...
                            <div className="col-lg-12 col-md-12">
                                <div className="widget-area">
                                        ...
                                        <div className="row justify-content-between align-items-center" style={!isEditMode ? { height: "110px" } : { paddingTop: "45px" }}>
                                            <div className="col d-flex">
                                                <h3 className="fs-4 text-start">
                                                    ...
                                                    {typeof selectedPlaylist === "string" || "undefined" ? (
                                                        <>
                                                            {isEditMode ? (
                                                                <>
                                                                    <input
                                  ...
                                  /> */}
                                                                ...
                                                                <>
                                                                    {isSelected ? <>{updatePlaylistTitle ? updatePlaylistTitle : savedPlaylistName}</> : null}
                                                                    {/* {selectedPlaylist}
                                ...
                                >
                                  ...
                                  /> */}
                                        ...
                                        {/* <Link to="/learntube-studio/playlist"> */}
                                        <PlaylistWidget
                                            userId={userId}
