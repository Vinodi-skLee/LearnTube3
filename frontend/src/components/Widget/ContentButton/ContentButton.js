...
const ContentButton = ({ lectureNum, setLectureNum, contentId, setContentId, contentNum, setContentNum, playing, setPlaying, lectures, videoNum, setVideoNum }) => {
        ...
        <>
            ...
            {lectures[lectureNum - 1].contents.length != 1 ? (
                <>
                    ...
                    <ul
                        className={contentNum != 0 ? "pagination-part shadow-none border-0 contentBtn" : "pagination-part shadow-none border-0 contentBtn_disabled"}
