      ...
      <div className="row">
            ...
            {typeof selectedPlaylist != "string" ? (
              <div className="col">
                <h3 className="col text-start m-0">
                  ...
                  {typeof selectedPlaylist === "string" ? selectedPlaylist : ""}
                </h3>
              </div>
            ) : (
              <div className="col">
                {updatePlaylist ? (
                  <h3 className="col text-start m-0">
                    <i className="fa fa-play-circle-o pe-1"></i>{" "}
                    {/*{typeof selectedPlaylist === 'string' ? selectedPlaylist : '선택된 playlist 제목'}}*/}
                    <input
                      type="text"
                      id="updatedTitle"
                      name="updatedTitle"
                  ...
                  <h3 className="col text-start m-0">
                    ...
                    {typeof selectedPlaylist === "string"
                      ...
                      : "선택된 playlist 제목"}
                    <i
                      className="fa fa-pencil ps-3 pt-3 orange-color"
                      onClick={() => setUpdatePlaylist(!updatePlaylist)}
                    ></i>{" "}
                    <i
                      className="fa fa-trash ps-3 pt-3 orange-color"
        ...
        {isVideoClicked ? (
          <div className=" col-lg-8" style={{ right: "0", bottom: "600px;" }}>
            ...
            <div className="row">
              <div class="col-12 my-5 lh-base">
                <div class="mx-md-3 fs-3 text-start">
                ...
                <div class="d-flex fw-light mt-3">
                  <div class="mx-2"></div>
                  <div class="fs-5 text-start text-muted">
                    전체 재생 시간:{" "}
                ...
                <div class="mt-5 mx-md-3 fs-5 text-start text-muted">
                  {clickedVideo.tag}
                </div>
              </div>
            </div>
          ...
          <>
            {selectedVideo === null ? (
              <div
                className=" col-lg-12 text-start fs-4 mt-50"
                style={{ right: "0", bottom: "600px;" }}
              >
                Playlist에 영상이 없습니다.
              </div>
            ) : null}
