        ...
        {isSelected ? (
          <>
            {clickedVideo ? (
              <>
                <div
                  className="d-flex justify-content-between align-items-center row mb-40"
                  style={{ right: "0px" }}
                ></div>
                <div
                ...
                <>
                  ...
                  <div className="col-md-4 col-sm-12 ">
                    <div
                      className="justify-content-between align-items-center p-3 pt-0 pb-2"
                      style={{
                        background: "#fff",
                    ...
                    >
                      <div class="d-flex text-start fs-6 fw-bold pt-3">
