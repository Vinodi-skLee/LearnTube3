    ...
    return (
        <div className="p-1 row" onClick={onClick}>
            <div className="col-lg-4 col-sm-12">
                <img className="img-fluid" style={{ minWidth: "120px" }} src={playlistImg} alt={playlistTitle} />
            </div>
            <div className="col-lg-8 col-sm-12 pt-2">
                <div className={isClicked ? "d-flex h4 text-start orange-color" : "d-flex h4 text-start"}>{playlistTitle ? playlistTitle : "강의제목"}</div>
