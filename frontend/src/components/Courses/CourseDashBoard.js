...
const CourseDashBoard = ({ courseClass, courseImg, courseTitle, progress, userCount, notice, creatorName, creatorId, openDate, classId, userId }) => {
                ...
                <div className="row d-flex justify-content-between ">
                    ...
                    {userId == creatorId ? (
                        <span className="text-end" style={{ zIndex: "100" }}>
                            ...
                            >
                                {/* 관리 */}
                                <AiTwotoneSetting size={24} data-for="handleSetClassRoom" data-tip />
                                <ReactTooltip
