                    ...
                    <div className="row ">
                        <div className="col-lg-3 col-md-12 col-sm-12 footer-widget md-mb-50">
                            ...
                            <div className="textwidget pr-60 md-pr-14">
                                <p className="text-white">YouTube에서 원하는 영상들만 골라 강의리스트를 완성하고, 강의실 제작자들이 체계적으로 짠 강의들을 골라 수강해보세요!</p>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-12 col-sm-12 footer-widget md-mb-50">
                        ...
                        <div className="col-lg-3 col-md-12 col-sm-12 footer-widget">
                            ...
                            <div className="recent-post mb-20">
                                <div className="post-img">{/* <img src={postImg1} alt="blog image" /> */}</div>
                            ...
                            <div className="recent-post mb-20">
                                <div className="post-img">{/* <img src={postImg2} alt="blog image" /> */}</div>
                                <div className="post-item">
                                    <div className="post-desc">
